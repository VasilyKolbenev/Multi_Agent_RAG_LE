...
class MultiAgent:
    ...
    async def run(self, query: str, k: int = 5, entities_filter: Optional[List[str]] = None) -> Dict[str, Any]:
        ...
        return {"plan": plan, "answer": answer, "critique": critique, "citations": cites,
